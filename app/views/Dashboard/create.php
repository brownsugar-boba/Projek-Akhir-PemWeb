...
<section class="hero dash-contents" id="content-page">
    ...
    <div class="upform frm container my-5">
          ...
          <form action="<?=BASEURL;?>/Dashboard/create_action" method="post">
              <div class="row">
              ...
              <div class="row">
                  <div class="form-floating form-group col-md-6 ">
                      <input type="text" class="form-control" name='Daerah' placeholder="Nama Daerah"  id="Daerah">
                      <label for="title">Nama Daerah</label>
                  </div>
                  <div class="form-floating form-group col-md-6">

                      <input type="text" class="form-control" name='n_penduduk' placeholder="Jumlah Penduduk"  id="n_penduduk">
                      <label for="author">Jumlah Penduduk</label>
                  </div>
              </div>
              <div class="row">
                  <div class="form-floating form-group col-md-6">
                      <input type="text" class="form-control" name='n_vaksin' placeholder="Jumlah Tervaksin" id="n_vaksin">
                      <label for="page_num">Jumlah Tervaksin</label>
                  </div>
                  <div class="form-floating form-group col-md-6">
                      <input type="text" class="form-control" name='n_keluhan' placeholder="Jumlah Keluhan"  id="n_keluhan">
              ...
              <div class="row">
                  <div class=" form-group col" >
                      <button type='submit' class='btn btn-outline-primary' name ='btn'>Insert</button>
                  </div>
              </div>
              </form>
